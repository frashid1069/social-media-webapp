...
class ImagePostTests(BaseAPITestCase):
    ...
    def setUp(self):
        ...
        self.image_post = ImagePost.objects.create(
            title="Image Title",
            author=self.author,
            image_content="data:image/jpeg;base64," + base64.b64encode(self.image.getvalue()).decode("utf-8"),
        )
    ...
    def test_create_image_post_success(self):
        ...
        self.assertIn("image_content", response.data)  # Verify base64 data is in the response
    ...
    def test_retrieve_image_post_success(self):
        ...
        self.assertIn("image_content", response.data)  # Content-Type based on the image MIME type
    ...
    def test_get_image(self):
        ...
        url = reverse('imagepost-get_image')  
        params = {'author_id': self.user.id, 'image_id': self.image_post.id}
        ...
        returned_image_binary = response.content
        returned_image_base64 = base64.b64encode(returned_image_binary).decode('utf-8')
        original_image_base64 = self.image_post.image_content.split(",")[1]
